...
export default function ArPage() {
  return (
    <div className="p-page py-24 flex flex-col items-center">
      ...
      <div className="flex p-24 border-8 mt-24 relative hover:cursor-pointer hover:bg-primary/10 duration-300 ease-in ">
        ...
        <div className="bg-background w-[10vw] h-[3vh] absolute -top-5 -translate-x-5" />
        <div className="bg-background h-[10vw] w-[3vh] absolute  -right-5 -translate-y-6 " />

        <div className="bg-background h-[10vw] w-[3vh] absolute  -left-5 -translate-y-6 " />
        <div className="bg-background w-[10vw] h-[3vh] absolute -bottom-5 -translate-x-5" />
      </div>
